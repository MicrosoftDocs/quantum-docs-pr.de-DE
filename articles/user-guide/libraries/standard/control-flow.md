...
<span data-ttu-id="08c2a-139">Das heißt, $c (UVU ^ \dagger) = u c (V) u ^ \dagger $.</span><span class="sxs-lookup"><span data-stu-id="08c2a-139">That is, $c(UVU^\dagger) = U c(V) U^\dagger$.</span></span>
