...
Diese Datei basiert auf Material aus den unten aufgeführten Projekten (IP-Adresse von Drittanbietern). The original copyright notice and the license under which Microsoft received such Third Party IP, are set forth below. Such licenses and notices are provided for informational purposes only. Microsoft lizenziert die Drittanbieter-IP-Adresse gemäß den Lizenzbedingungen für das Microsoft-Produkt. Microsoft reserves all other rights not expressly granted under this agreement, whether by implication, estoppel or otherwise.
...
---------------------------------------
Copyright (c) 2008, 2009, 2010, 2011, 2012, 2013, 2014 Antoine Aubry und Mitwirkende
...
## <a name="xunitrunnervisualstudio-notices-and-information"></a>Hinweise und Informationen zu xUnit. Runner. VisualStudio
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten

Lizenziert unter der Apache-Lizenz, Version 2,0 ("License"); Sie dürfen diese Datei nicht verwenden, außer in Übereinstimmung mit der Lizenz.
...
## <a name="xunitrunnerconsole-notices-and-information"></a>Hinweise und Informationen zu xUnit. Runner. Console
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="xunitextensibilitycore-notices-and-information"></a>Hinweise und Informationen zu xUnit. Extensibility. Core
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="xunitcore-notices-and-information"></a>Hinweise und Informationen zu xUnit. Core
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="xunitassert-notices-and-information"></a>xUnit. Assert-Hinweise und-Informationen
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="xunitanalyzers-notices-and-information"></a>Hinweise und Informationen zu xUnit. Analyzers
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="xunitabstractions-notices-and-information"></a>Hinweise und Informationen zu xUnit. Abstraktionen
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="xunit-notices-and-information"></a>xUnit-Hinweise und-Informationen
---------------------------------------
Copyright (c) .Net Foundation und Mitwirkende alle Rechte vorbehalten
...
## <a name="managedesent-notices-and-information"></a>Hinweise und Informationen zu managedesent
---------------------------------------
...
## <a name="fscheck-notices-and-information"></a>Hinweise und Informationen zu den Überschriften
---------------------------------------
...
* Weder der Name von fscheck noch die Namen der Mitwirkenden können verwendet werden, um aus dieser Software abgeleitete Produkte ohne vorherige schriftliche Berechtigung zu unterstützen oder zu bewerben.

DIESE SOFTWARE WIRD VON DEN URHEBERRECHTSINHABERN UND MITWIRKENDEN „WIE BESEHEN“ ZUR VERFÜGUNG GESTELLT UND JEGLICHE AUSDRÜCKLICHE ODER KONKLUDENTE GEWÄHRLEISTUNG, EINSCHLIESSLICH, ABER NICHT BESCHRÄNKT AUF DIE KONKLUDENTE GEWÄHRLEISTUNG DER HANDELSÜBLICHKEIT UND EIGNUNG FÜR EINEN BESTIMMTEN ZWECK, WIRD ABGELEHNT. IN KEINEM FALL SIND DER URHEBERRECHTSINHABER ODER DIE MITWIRKENDEN HAFTBAR FÜR DIREKTE, INDIREKTE, ZUFÄLLIGE, BESONDERE, EXEMPLARISCHE ODER FOLGESCHÄDEN (EINSCHLIESSLICH, ABER NICHT BESCHRÄNKT AUF DIE BESCHAFFUNG VON ERSATZGÜTERN ODER -DIENSTLEISTUNGEN, NUTZUNGSAUSFALL, DATEN- ODER GEWINNAUSFALL ODER GESCHÄFTSUNTERBRECHUNG), DIE JEDOCH VERURSACHT WURDEN UND AUF EINER HAFTUNGSTHEORIE BERUHEN, UNABHÄNGIG DAVON, OB SIE VERTRAGLICH, STRENG HAFTBAR ODER UNERLAUBT (EINSCHLIESSLICH FAHRLÄSSIGKEIT ODER ANDERWEITIG) SIND, DIE SICH IN IRGENDEINER WEISE AUS DER NUTZUNG DIESER SOFTWARE ERGEBEN, SELBST WENN AUF DIE MÖGLICHKEIT SOLCHER SCHÄDEN HINGEWIESEN WURDE.
...
## <a name="fparsec-notices-and-information"></a>Hinweise und Informationen zu den Informationen
---------------------------------------
...
2,1 vereinfachte BSD-Lizenz

Copyright (c) 2007 \ u20122017, Stephan Tolksdorf. Alle Rechte vorbehalten.
