...
### <a name="overview-of-features"></a>Übersicht über Features
...
Ein Beispiel für eine solche Änderung ist das symboltupel in benutzerdefinierten Spezialisierungs Funktionen. In früheren Versionen wurde in einer kontrollierten oder kontrollierten Adjoint-Spezialisierungs Deklaration ein einzelnes Symbol Argument angegeben, beginnend mit 0,3 wird empfohlen, ein derartiges symboltupel für alle Spezialisierungen mit `...` anzugeben, das angibt, dass der Compiler die Symbole sollten bei Bedarf von der Aufruf baren Deklaration migriert werden. 
